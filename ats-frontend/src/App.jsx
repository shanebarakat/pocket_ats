...
import { FileUp, Send, FileCheck, Info, ArrowUp, Menu, DoorClosedIcon as Close } from 'lucide-react';
  ...
  const renderLanding = () => (
    <Fade in={!started} timeout={800}>
      <Box sx={{ textAlign: 'center', mt: 1, px: isMobile ? 2 : 0, width: '100%', position: 'relative', zIndex: 1 }}>
        ...
        >
          <Typography variant={isMobile ? 'h3' : 'h1'} sx={{ fontWeight: 700, mb: 1, color: 'text.primary', mt: isMobile ? 4 : 0 }}>
            Pocket ATS
          </Typography>
  ...
  const renderResultBox = (title, score, index) => (
    ...
    >
      <StyledPaper sx={{ 
        ...
        <Typography variant="h6" sx={{ mb: 2, fontWeight: 500, color: 'text.primary' }}>{title}</Typography>
          ...
          <DialogContent sx={{ p: 3, bgcolor: 'background.paper' }}>
            <DialogContentText component="div" sx={{ p: 2, color: 'text.primary' }}>
              ...
              <Typography variant="body1" sx={{ mb: 3, color: 'text.primary' }}>
                We use three advanced methods used in Applicant Tracking Systems (ATS) to give you the most accurate assessment.
              </Typography>
              ...
              <Typography variant="body1" sx={{ 
                ...
                Pocket ATS combines all three methods to give you a comprehensive match score and help optimize your resume!
              </Typography>
            </DialogContentText>
          </DialogContent>
        ...
        <Box component="footer" sx={{ 
          ...
          <Container maxWidth="lg">
            <Typography variant="body2" color="text.secondary">
              Built by Shane Barakat 2025 | Check out the code here 🙂 <a href='https://github.com/shanebarakat/pocket_ats' style={{ color: '#90caf9' }}>Github</a>
            </Typography>
          </Container>
        </Box>
      </Box>
